...
ELSEIF(CHIP_PLATFORM STREQUAL "cvitek")
  set(PLATFORM_LINK_LIBS
    ${PLATFORM_LINK_LIBS}
  )
ELSEIF(CHIP_PLATFORM STREQUAL "hisi" OR CHIP_PLATFORM STREQUAL "hisi_v6.0" )
  set(PLATFORM_LINK_LIBS
    ${PLATFORM_LINK_LIBS}
    -lss_mpi_sysmem
    -lsecurec
...
target_link_libraries(lvgl ${PLATFORM_LINK_LIBS})
...
if (NOT LV_BUILD_USE_KCONFIG)
    ...
    elseif(LV_BUILD_CONF_DIR)
        ...
        set(CONF_INC_DIR ${LVGL_ROOT_DIR})
        set(CONF_PATH ${CONF_INC_DIR}/lv_conf.h)
...
if(CONFIG_LV_BUILD_DEMOS)
    ...
    if (NOT BUILD_SHARED_LIBS)
        ...
        target_link_libraries(lvgl_demos lvgl)
    endif()
